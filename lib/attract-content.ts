...
export const websiteReview = {
  ...
  /** v1.4 §4 — distinct artifact from the Revenue Leak Audit. */
  distinction: "This is a different thing from the Revenue Leak Audit, which measures how quickly enquiries to your business get answered. A business can genuinely need both.",
} as const;
...
export const attractContinuity = {
  ...
  /* Canonical ten-stage Revenue Engine. The previous six-stage journey
     (Attract, Engage, Qualify, Book, Convert, Retain) is superseded. */
  journey: [
    "Attract",
    "Capture",
    "Respond",
...
export const attractEligibility = {
  ...
  body: "Service businesses where an enquiry turns into a consultation, an appointment and then a returning customer. Aesthetic clinics are one of the verticals we work with, alongside healthcare, wellness, automotive, professional services and others. Website work is not limited to any one industry.",
} as const;
